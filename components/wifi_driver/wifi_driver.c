 ...
 * WIFI EVENT HANDLER
 * 
 * hàm xương sống của wifi
 * xử lí và làm theo cách sự kiện diễn ra
 * 
 * 
 */
...
{
    // === xử lí sự kiện của wifi mà đã được khai báo sẵn, ví dụ: bắt đầu chế độ station 
 ...
 * WIFI INITIALIZE 
 * 
 * khởi tạo những gì cần trước cho wifi handler
 * ví dụ như event-groups, esp-netif 
 *                          network interface
 * 
 */
...
/**************************
 * 
 * KHỞI TẠO CHẾ ĐỘ WIFI STA
 * 
 * bao gồm cấu hình ssid và mật khẩu 
 * và nhiều thứ khác liên quan 
 * 
 * 
 */
static esp_err_t wifi_station_initialize(void)
{
...
void wifi_start(void) {
    ...
    err = wifi_station_initialize(); // khởi tạo trạm wifi hà? 
    if (err != ESP_OK) {
